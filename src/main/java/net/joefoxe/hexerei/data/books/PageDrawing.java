...
//            "textures/gui/text.png");
    ...
    public static ItemStack getTagStack(TagKey<Item> key) {
        Optional<Item> optional = Optional.empty();// TODO proper registryRegistries.ITEM.getTag(key).flatMap(tag -> tag.getRandomElement(RandomSource.create())).map(Holder::value);
...
//        return Registry.ITEM.getTag(TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(loc))).flatMap(tag -> tag.getRandomElement(new Random())).map(Holder::value);
    ...
    public static Optional<Item> getTagStackStatic(TagKey<Item> key) {
        ...
        // TODO proper static item?
        return Optional.empty(); //TagKey.codec(Registries.ITEM).map(tag -> tag.);//ResourceKey.codec(Registries.ITEM).flatMap(tag -> tag.getRandomElement(RandomSource.create())).map(Holder::value);
    }
    ...
    public static void renderItem(BookOfShadowsAltarTile tileEntityIn, @NotNull BookItemsAndFluids itemStackElement, PoseStack matrixStackIn, MultiBufferSource buffer, float xIn, float yIn, float zLevel, int combinedLight, int combinedOverlay, PageOn pageOn, boolean isItem) {
        ...
        matrixStackIn.mulPose(Vector3f.YP.rotationDegreesf(90));
        ...
        org.joml.Matrix3f matrix3f = matrixStackIn.last().normal();
        matrixStackIn.mulPose(Vector3f.YP.rotationDegreesf(180f));
        matrixStackIn.mulPose(Vector3f.ZP.rotationDegreesf(-90));
        ...
        try {
            ...
            if (itemModel.isGui3d()) {
                matrixStackIn.last().normal().mul(ITEM_LIGHT_ROTATION_3D.toMatrix3F());
            } else {
                matrixStackIn.last().normal().mul(ITEM_LIGHT_ROTATION_FLAT.toMatrix3F());
            }
    ...
    public static void renderGuiItem(MultiBufferSource bufferSource, Font font, ItemStack itemStack, PoseStack matrixStackIn, float xIn, float yIn, int overlay, int light) {
        ...
        try {
            ...
            if (Minecraft.getInstance().cameraEntity != null) {
                ...
                matrixStackIn.last().normal().mul(quat.toMatrix3F());
            }
            if (itemModel.isGui3d()) {
                matrixStackIn.last().normal().mul(Util.make(() -> {
                    Quaternion quaternion = new Quaternion(Vector3f.XP, 65f, true);
                    quaternion.mul(new Quaternion(Vector3f.YP, 50f, true));
                    return quaternion.toMatrix3F();
                }));
            } else {
                matrixStackIn.last().normal().mul(new Quaternion(Vector3f.XP, 45f, true).toMatrix3F());
            }
    ...
    public static void translateToLeftPageUnder(BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStack, boolean isItem, ItemDisplayContext transformType) {
        ...
        matrixStack.mulPose(Vector3f.YP.rotationDegreesf(tileEntityIn.degreesSpunRender));
        if (!isItem)
            matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-(tileEntityIn.degreesOpenedRender / 2 + 45)));
        else
            matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-(tileEntityIn.degreesOpenedRender / 2 - 10)));
        if (isItem && transformType != ItemDisplayContext.NONE)
            matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-55));
        matrixStack.mulPose(Vector3f.YP.rotationDegreesf(-tileEntityIn.degreesFloppedRender));
        matrixStack.translate(0, 0, -(tileEntityIn.degreesFloppedRender / 10f) / 32);
        matrixStack.translate(0, 1f / 32f, 0);
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf(-(80f - tileEntityIn.degreesOpenedRender / 1.12f)));
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf((-(80f - tileEntityIn.degreesOpenedRender / 1.12f) / 90f) * (-tileEntityIn.pageTwoRotationRender)));
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf((-(80f - tileEntityIn.degreesOpenedRender / 1.12f) / 90f) * (tileEntityIn.pageOneRotationRender / 16f)));
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf(-180));
    ...
    public static void translateToLeftPage(BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStack, boolean isItem, ItemDisplayContext transformType) {
        ...
        if (isItem && transformType != ItemDisplayContext.NONE)
            matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-55));
        matrixStack.mulPose(Vector3f.XP.rotationDegreesf(degreesOpened));
...
//        matrixStack.translate(0,1/64f,0);
    ...
    public static void translateToRightPageUnder(BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStack, boolean isItem, ItemDisplayContext transformType) {
        ...
        matrixStack.translate(0, 1f / 32f, 0);
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf((80f - tileEntityIn.degreesOpenedRender / 1.12f)));
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf(((80f - tileEntityIn.degreesOpenedRender / 1.12f) / 90f) * (-tileEntityIn.pageOneRotationRender)));
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf(((80f - tileEntityIn.degreesOpenedRender / 1.12f) / 90f) * (tileEntityIn.pageTwoRotationRender / 16f)));
//        matrixStack.translate(0, 1 / 64f, 0);
    ...
    public static void translateToLeftPagePrevious(BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStackIn, boolean isItem, ItemDisplayContext transformType) {
        ...
        if (tileEntityIn.turnPage != 2 && tileEntityIn.turnPage != -1) {
            ...
            if (!isItem)
                ...
                matrixStackIn.mulPose(Vector3f.XP.rotationDegreesf(-(tileEntityIn.degreesOpenedRender / 2 - 10)));
            if (isItem && transformType != ItemDisplayContext.NONE)
                matrixStackIn.mulPose(Vector3f.XP.rotationDegreesf(-55));
            matrixStackIn.mulPose(Vector3f.XP.rotationDegreesf(degreesOpened));
...
//            matrixStackIn.translate(0, 1 / 64f, 0);
    ...
    public void translateToMiddleButton(BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStack, boolean isItem, ItemDisplayContext transformType) {
        ...
        if (!isItem)
            ...
            matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-(tileEntityIn.degreesOpenedRender / 2 - 13)));
        if (isItem && transformType != ItemDisplayContext.NONE)
            matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-55));
        matrixStack.mulPose(Vector3f.XP.rotationDegreesf(degreesOpened));
        matrixStack.mulPose(Vector3f.YP.rotationDegreesf(-tileEntityIn.degreesFloppedRender));
        matrixStack.translate(0, 0, -(tileEntityIn.degreesFloppedRender / 10f) / 32);
        matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-90));
        matrixStack.mulPose(Vector3f.YP.rotationDegreesf(270));
            ...
            if (transformType == ItemDisplayContext.NONE) {
                for (int i = 0; i < page.itemList.size(); i++) {
                    ...
                    if (pageOn == PageOn.LEFT_PAGE) {
                        ...
                        vector3f_1.transform(Vector3f.YP.rotationDegreesNormal(10 + tileEntityIn.degreesOpenedRender / 1.12f));
                        vector3f_1.transform(Vector3f.XP.rotationDegreesNormal(45 - tileEntityIn.degreesOpenedRender / 2f));

                        vector3f.add(vector3f_1);

                        vector3f.transform(Vector3f.YP.rotationDegreesNormal(tileEntityIn.degreesSpunRender));
...
//        livingEntity.tickCount += 1;
        ...
        Quaternion $$10 = Vector3f.ZP.rotationDegreesNormal(180.0F);
        Quaternion $$11 = Vector3f.XP.rotationDegreesNormal($$7 * 20.0F);
        $$10.mul($$11);
        ...
        $$11.conj();
        $$17.overrideCameraOrientation($$11.toQuatF());
    ...
    public void drawEntity(BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStackIn, MultiBufferSource bufferIn, float scale, float xIn, float yIn, float rot, int p_98853_, float p_98854_, float p_98855_, Entity entity, int combinedLightIn, int combinedOverlayIn, PageOn pageOn, boolean isItem) {
        ...
        Quaternion $$11 = Vector3f.XP.rotationDegreesNormal($$7 * 20.0F);
        $$10.mul($$11);
        matrixStackIn.mulPose(Vector3f.YP.rotationDegreesf(-(rot * 0.60F + entity.getId())));
        EntityRenderDispatcher $$17 = Minecraft.getInstance().getEntityRenderDispatcher();
        $$11.conj();
        $$17.overrideCameraOrientation($$11.toQuatF());
        $$17.setRenderShadow(false);
...
//                vector3f_1.transform(Vector3f.YP.rotationDegreesNormal(10 + tileEntityIn.degreesOpenedRender / 1.12f));
    ...
    public AABB getpositionAABBNext(BookOfShadowsAltarTile altarTile) {
        ...
        vector3f_1.transform(Vector3f.YP.rotationDegreesNormal(-(10 + altarTile.degreesOpened / 1.12f)));
        vector3f_1.transform(Vector3f.XP.rotationDegreesNormal(45 - altarTile.degreesOpened / 2f));
        vector3f.add(vector3f_1);
        vector3f.transform(Vector3f.YP.rotationDegreesNormal(altarTile.degreesSpun));
...
//        System.out.println(event.getKey() == ModKeyBindings.bookJEIShowUses.getKey().getValue());
        ...
        if (true/*!HexereiJeiCompat.LOADED*/)
            return;
...
//            System.out.println("The ray intersects the plane at " + ip);
    ...
    public Vec3 planeNormal(BookOfShadowsAltarTile altarTile, PageOn pageOn) {
        if (pageOn == PageOn.RIGHT_PAGE) {
            ...
            vector3f_2_1.transform(Vector3f.YP.rotationDegreesNormal(-(10 + altarTile.degreesOpened / 1.12f)));
            vector3f_2_1.transform(Vector3f.XP.rotationDegreesNormal(45 - altarTile.degreesOpened / 2f));

            vector3f_2.add(vector3f_2_1);

            vector3f_2.transform(Vector3f.YP.rotationDegreesNormal(altarTile.degreesSpun));
            ...
            vector3f_3_1.transform(Vector3f.YP.rotationDegreesNormal(-(10 + altarTile.degreesOpened / 1.12f)));
            vector3f_3_1.transform(Vector3f.XP.rotationDegreesNormal(45 - altarTile.degreesOpened / 2f));

            vector3f_3.add(vector3f_3_1);

            vector3f_3.transform(Vector3f.YP.rotationDegreesNormal(altarTile.degreesSpun));
                ...
                if (page1 != null) {
                    ...
                    for (int i = 0; i < page1.itemList.size(); i++) {
                        ...
                        if (aabb.contains(intersectionVec) && intersectionVec.subtract(playerIn.getEyePosition()).length() <= reach) {
                            ...
                            if (bookItemStackInSlot.item != null)
                                itemRegistryName = Registries.ITEM.toString();//Registry.ITEM.getKey(bookItemStackInSlot.item.getItem()).toString();
                            else
                                itemRegistryName = Registries.FLUID.toString();// TODO proper registries?Registry.FLUID.getKey(bookItemStackInSlot.fluid.getFluid()).toString();
                    ...
                    for (int i = 0; i < page1.imageList.size(); i++) {
                        ...
                        vector3f_1.transform(Vector3f.YP.rotationDegreesNormal(10 + altarTile.degreesOpenedRender / 1.12f));
                        vector3f_1.transform(Vector3f.XP.rotationDegreesNormal(45 - altarTile.degreesOpenedRender / 2f));

                        vector3f.add(vector3f_1);

                        vector3f.transform(Vector3f.YP.rotationDegreesNormal(altarTile.degreesSpunRender));
                        ...
                        for (int i = 0; i < page2.itemList.size(); i++) {
                            ...
                            if (aabb.contains(intersectionVec) && intersectionVec.subtract(playerIn.getEyePosition()).length() <= reach) {
                                ...
                                if (bookItemStackInSlot.item != null)
                                    ...
                                    itemRegistryName = Registries.FLUID.toString(); //Registry.FLUID.getKey(bookItemStackInSlot.fluid.getFluid()).toString();
...
//                            loc.set(bookImageEffect.hoverImage.imageLoc);
    ...
    public void drawSlot(BookOfShadowsAltarTile tileEntityIn, ItemStack stack, PoseStack matrixStack, MultiBufferSource bufferSource, float xIn, float yIn, float zLevel, int light, int overlay, PageOn pageOn, boolean isItem) {
        ...
        matrixStack.mulPose(Vector3f.YP.rotationDegreesf(90));
        matrixStack.translate(-8f / 16f, 5.5f / 16f, -0.012f / 16f);
        matrixStack.scale(0.5f, 0.5f, 0.5f);
        matrixStack.mulPose(Vector3f.ZP.rotationDegreesf(-90));
        ...
        org.joml.Matrix4f matrix = matrixStack.last().pose();
        VertexConsumer buffer = bufferSource.getBuffer(RenderType.entityCutout(new ResourceLocation("hexerei:textures/book/slot.png")));

        matrixStack.last().normal().mul(ITEM_LIGHT_ROTATION_FLAT.toMatrix3F());
        org.joml.Matrix3f normal = matrixStack.last().normal();
        int u = 0;
        int v = 0;
        int imageWidth = 32;
        int imageHeight = 32;
...
//                    height2 *= ((float)amount / (float)capacity);
    ...
    private static void drawTextureWithMasking(PoseStack poseStack, MultiBufferSource bufferSource, int capacity, int amount, float xCoord, float yCoord, TextureAtlasSprite textureSprite, int color, int maskTop, int maskRight, float zLevel, int light, int overlay, float x_offset, float y_offset, float width, float height) {
        ...
        poseStack.mulPose(Vector3f.XP.rotationDegreesf(90));
...
//                : (float)((Math.pow(2 * x - 2, 2) * ((c2 + 1) * (x * 2 - 2) + c2) + 2) / 2);
    ...
    public void drawTooltipImage(ItemStack stack, BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStack, MultiBufferSource bufferSource, float zLevel, int light, int overlay, boolean isItem) {
        ...
        if (!this.tooltipStack.isEmpty()) {
            ...
            String modId = Registries.ITEM.registry().getNamespace();//Registry.ITEM.getKey(this.tooltipStack.getItem()).getNamespace();
    ...
    public void renderTooltip(ItemStack stack, MultiBufferSource buffer, PoseStack p_169389_, List<Component> components, Optional<TooltipComponent> p_169391_, int p_169392_, int p_169393_, int overlay, int light) {
        ...
        List<ClientTooltipComponent> list = ForgeHooksClient.gatherTooltipComponents(stack, components, p_169392_, 350, 750, Minecraft.getInstance().font);
        ...
        List<ClientTooltipComponent> list2 = ForgeHooksClient.gatherTooltipComponents(stack, components, p_169392_, 350, 750, Minecraft.getInstance().font);
    ...
    private void renderTooltipInternal(MultiBufferSource bufferSource, PoseStack matrixStack, List<ClientTooltipComponent> clientTooltipComponentList, List<ClientTooltipComponent> clientTooltipComponentList2, int p_169386_, int p_169387_, int overlay, int light) {
        if (!clientTooltipComponentList.isEmpty()) {
           ...
           // RenderTooltipEvent.Pre preEvent = ForgeHooksClient.onRenderTooltipPre(this.tooltipStack, matrixStack, p_169386_, p_169387_, 750, 750, clientTooltipComponentList, Minecraft.getInstance().font, Minecraft.getInstance().font);
            ...
            //ForgeHooksClient.onRenderTooltipPre(this.tooltipStack, Minecraft.getInstance().gui.get)
            ...
            int l1 = k2;
//
            org.joml.Matrix4f matrix4f = matrixStack.last().pose();
            int l2;
            ...
            for (l2 = 0; l2 < clientTooltipComponentList.size(); ++l2) {
                ...
                if (clientTooltipComponent2 instanceof HexereiBookTooltip hexereiBookTooltip)
                    hexereiBookTooltip.renderText(preEvent.getFont(), j2, l1, new Matrix4f(matrix4f), multibuffersource$buffersource, overlay, light);
    ...
    public void drawBookmark(BookImage bookImage, BookOfShadowsAltarTile tileEntityIn, PoseStack matrixStack, MultiBufferSource bufferSource, float zLevel, float rotate, int light, int overlay, PageOn pageOn, int color, boolean isItem, ItemDisplayContext transformType) {
        ...
        bookImage.effects.forEach((bookImageEffect -> {
            if (bookImageEffect.type.equals("tilt")) {
                matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-bookImageEffect.amount * Mth.sin((Hexerei.getClientTicks()) / bookImageEffect.speed)));
            }
        }));
        matrixStack.mulPose(Vector3f.XP.rotationDegreesf(rotate));
        if (transformType != ItemDisplayContext.NONE)
            matrixStack.mulPose(Vector3f.ZP.rotationDegreesf(-35));
            ...
            if (flag.get()) {
                ...
                bookImageEffect.hoverImage.effects.forEach((bookHoverImageEffect -> {
                    if (bookHoverImageEffect.type.equals("tilt")) {
                        matrixStack.mulPose(Vector3f.XP.rotationDegreesf(-bookHoverImageEffect.amount * Mth.sin((Hexerei.getClientTicks()) / bookHoverImageEffect.speed)));
                    }
                }));
