...
public final class Quaternion {
    ...
    public org.joml.Matrix3f toMatrix3F() {
        org.joml.Matrix3f newM = new org.joml.Matrix3f();
        float f = i();
        float f1 = j();
        float f2 = k();
        float f3 = r();
        ...
        float f11 = f1 * f3;
        float f12 = f2 * f3;
        newM.m10 = 2.0F * (f7 + f12);
        newM.m01 = 2.0F * (f7 - f12);
        newM.m20 = 2.0F * (f9 - f11);
        newM.m02 = 2.0F * (f9 + f11);
        newM.m21 = 2.0F * (f8 + f10);
        newM.m12 = 2.0F * (f8 - f10);
        return newM;
    }
