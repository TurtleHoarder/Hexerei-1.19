package net.joefoxe.hexerei.util.legacymath;
...
public final class Vector3f {
    ...
    public Quaternionf rotationf(float pValue) {
        Quaternion q =  new Quaternion(this, pValue, false);
        return new Quaternionf(q.i(), q.j(), q.k(), q.r());
    }

    public Quaternionf rotationDegrees(float pValue) {
        return new Quaternion(this, pValue, true).toQuatF();
    }

    public Quaternion rotationDegreesNormal(float pValue) {
        return new Quaternion(this, pValue, true);
    }

    public Quaternionf rotationDegreesf(float pValue) {
        Quaternion q = new Quaternion(this, pValue, true);
        return new Quaternionf(q.i(), q.j(), q.k(), q.r());
    }
